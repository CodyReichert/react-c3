...
var ChartComponent = _react2.default.createClass({
    ...
    componentDidMount: function componentDidMount() {
        this._generateChart(this.props.data.columns, this.props.type, this.props.element, this.props.options);
    },
    ...
    _generateChart: function _generateChart(columns, type, element, options) {
