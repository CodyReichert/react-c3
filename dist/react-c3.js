...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChartJsx = __webpack_require__(1);

	var _ChartJsx2 = _interopRequireDefault(_ChartJsx);

	exports.Chart = _ChartJsx2['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChartComponent = _react2['default'].createClass({
	    ...
	    _generateChart: function _generateChart(columns, type, element) {
	        this.chart = _c32['default'].generate({
	            bindto: '#' + element,
	            data: {
	                columns: columns,
	                type: type
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (window) {
	    ...
	    if (true) {
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(3)], __WEBPACK_AMD_DEFINE_FACTORY__ = (c3), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
